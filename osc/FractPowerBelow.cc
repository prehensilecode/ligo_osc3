// Yo, Emacs! This is -*- C++ -*-
//
// $Id: FractPowerBelow.cc,v 1.2 2002/05/01 18:47:43 dwchin Exp $
//
...
osc::FractPowerBelow::FractPowerBelow(Dacc       *access,
                                      ostream    *outstream,
                                      string      chanName,
                                      osc::IntParMap &intparams,
                                      osc::DblParMap &dblparams,
                                      int debug)
    : OperStateCond(access, outstream, chanName, "fractpowerbelow",
...
double osc::FractPowerBelow::powerFract(const TSeries *ptx,
                                       double         freqlo,
                                       double         freqhi)
{
...
bool osc::FractPowerBelow::satisfied()
{
    if (mDebug > 0) {
