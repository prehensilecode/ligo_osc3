// Yo, Emacs! This is -*- C++ -*-
//
// $Id: BitNand.cc,v 1.4 2002/06/27 18:27:00 dwchin Exp $
//
...
bool osc::BitNand::satisfied()
{
    if (mDebug > 0) {
        cout << "osc::BitNand on '" << mChannel
    ...
    if (t0 == mCurResults.mT0) {
        ...
        // if error, give up
        if (nRead != nSample) {
            cerr << "osc::bitnand: error reading data from channel '"
