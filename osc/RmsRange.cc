// Yo, Emacs! This is -*- C++ -*-
//
// $Id: RmsRange.cc,v 1.2 2002/05/01 18:47:43 dwchin Exp $
//
...
osc::RmsRange::RmsRange(Dacc       *access,
                        ostream    *outstream,
                        string      chanName,
                        osc::IntParMap &intparams,
                        osc::DblParMap &dblparams,
                        int debug)
    : OperStateCond(access, outstream, chanName, "rmsrange",
...
bool osc::RmsRange::satisfied()
{
    ...
    if (t0 == mCurResults.mT0) {
        ...
        if (mDebug > 0) {
            printf("osc::RmsRange on '%s': RMS = %6.4f\n",
