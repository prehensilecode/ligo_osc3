// Yo, Emacs! This is -*- C++ -*-
//
// $Id: FractPowerBelow.hh,v 1.4 2002/05/01 18:47:43 dwchin Exp $
//
...
#ifndef OSCFRACTPOWERBELOW_HH
#define OSCFRACTPOWERBELOW_HH
...
namespace osc
{
    ...
    // FRACTPOWERBELOW
    //
    class FractPowerBelow
        : public OperStateCond
    {
    public:
        FractPowerBelow(Dacc            *access,
    ...
    private:
        ...
        /** {\tt FractPowerbelow} has three parameters.  This OSC is
         * satisfied if the fractional power in the frequency range
         * $[{\mathtext freqlo}, {\mathtext freqhi}]$ is below {\tt
...
#endif // !defined OSCFRACTPOWERBELOW_HH
