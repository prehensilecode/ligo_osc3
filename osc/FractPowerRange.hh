// Yo, Emacs! This is -*- C++ -*-
//
// $Id: FractPowerRange.hh,v 1.4 2002/05/01 18:47:43 dwchin Exp $
//
...
#ifndef OSCFRACTPOWERRANGE_HH
#define OSCFRACTPOWERRANGE_HH
...
namespace osc
{
    ...
    // FRACTPOWERRANGE
    //
    class FractPowerRange
        : public OperStateCond
    {
    public:
        FractPowerRange(Dacc            *access,
    ...
    private:
        ...
        /** {\tt FractPowerrange} has three parameters.  This OSC is
         * satisfied if the fractional power in the frequency range
         * $[{\mathtext freqlo}, {\mathtext freqhi}]$ is in the range
         * $[lo, hi]$. The fractional power is defined as the ratio of
         ...
         *    \item {\bf {\tt lo}} Lower limit of fractional power
         *    \item {\bf {\tt hi}} Upper limit of fractional power
         * \end{enumerate}
         */
    };
...
#endif // !defined OSCFRACTPOWERRANGE_HH
