// Yo, Emacs! This is -*- C++ -*-
//
// $Id: BitNor.hh,v 1.2 2002/02/13 05:44:21 sigg Exp $
//
...
namespace osc
{
    ...
    private:
        ...
        /** {\tt bitnor} has one \texttt{int} parameter and one
         *  \texttt{double} parameter:
         * \begin{enumerate}
         *    \item {\bf {\tt mask}} This OSC is satisfied if the
         *          Boolean NOR of the mask  with some {\tt fraction}
